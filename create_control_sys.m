function [G, K, poles_controller, poles_observer ]  = create_control_sys(sys, Per_OS, tp, ts, ratio_K_G, dom_sub_ratio) % %Overshoot, rise time, settling time, 
